      ...
      <div className="flex flex-col  gap-4">
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Complete roadmap to learn HTMl & CSS
            </p>

            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/html-css-roadmap-for-beginners-in-2022"
                target="_blank"
        ...
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Complete roadmap to learn JavaScript            </p>

            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/javascript-roadmap-for-beginners-in-2022"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="px-2 py-1 text-xs font-bold text-[#101010] hover:text-white uppercase transition-colors duration-200 transform bg-white rounded hover:bg-[#101010]  focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
        ...
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/what-to-learn-before-starting-web-development"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="px-2 py-1 text-xs font-bold text-[#101010] hover:text-white uppercase transition-colors duration-200 transform bg-white rounded hover:bg-[#101010]  focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
        ...
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/are-you-a-javascript-developer-top-22-github-repos-for-javascript-developers"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="px-2 py-1 text-xs font-bold text-[#101010] hover:text-white uppercase transition-colors duration-200 transform bg-white rounded hover:bg-[#101010]  focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
        ...
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/25-must-use-insane-websites-for-content-creators"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="px-2 py-1 text-xs font-bold text-[#101010] hover:text-white uppercase transition-colors duration-200 transform bg-white rounded hover:bg-[#101010]  focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
        ...
        <div className="p-6 flex gap-4 max-w-2xl items-center bg-[#101010] rounded-lg border border-white">
          <div className="w-full">
            ...
            <div className="flex justify-between mt-3 item-center">
              <a
                href="https://mdjunaid.hashnode.dev/top-10-javascript-array-methods-decoded"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="px-2 py-1 text-xs font-bold text-[#101010] hover:text-white uppercase transition-colors duration-200 transform bg-white rounded hover:bg-[#101010]  focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
